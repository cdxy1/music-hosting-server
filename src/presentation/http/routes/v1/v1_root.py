...
from src.presentation.http.routes.v1.tracks.tracks import router as track_router

INTERNAL_ROUTERS = (author_router, genre_router, release_router, track_router)
