...
class CreateReleaseUsecase(BaseUsecase):
    @override
    def __init__(self, release_repo: IRepository, author_repo: IRepository, genre_repo: IRepository, uow_factory: Callable[[], IUnitOfWork], cache: ICacheWrapper, dispatcher: IDispatcher):
    ...
    async def __call__(self, release_dto: ReleaseInputDTO):
        ...
        async with uow() as session:
            ...
            self.dispatcher.dispatch_upload_file("images", release.id, release_dto.image_data)
